...
<body class="bg-white flex flex-col min-h-screen text-gray-200">
    ...
    <nav class="bg-gradient-to-r from-blue-500 to-blue-600 p-4 shadow-lg">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <a href="{{ route('transaction.index') }}" class="bg-white text-blue-600 px-4 py-2 rounded-lg hover:bg-gray-100 transition duration-300 shadow-md">
                Back
            </a>
        </div>
    </nav>
    ...
    <div class="container mx-auto py-6 px-4">
        <div class="bg-gray-800 shadow-lg rounded-lg p-6">
            <form method="GET" action="{{ route('transaction.create') }}" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Filter Area -->
                <div>
    ...
    <div class="container mx-auto py-6 px-4">
        <form method="POST" action="{{ route('transaction.store') }}">
                    ...
                    <div class="bg-gray-800 border border-2 shadow-xl rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center mt-4">
                                ...
                                <input type="number" name="produk[{{ $product->id }}][quantity]" value="1" min="1" class="w-12 text-center bg-gray-700 text-white">
            ...
            <button type="submit" class="mt-6 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-300 shadow-md">Buat Transaksi</button>
        </form>
    </div>
