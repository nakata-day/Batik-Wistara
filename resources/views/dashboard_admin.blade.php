...
<head>
    ...
    <title>Admin Dashboard - BatikWistara</title>
...
<body class="bg-white flex flex-col min-h-screen">
    ...
    <div class="flex">
        <div class="bg-blue-500 text-white w-64 min-h-screen p-4">
            ...
            <nav class="space-y-4">
                <a href="{{ route('product.list') }}" class="block bg-white text-blue-500 px-4 py-2 rounded hover:underline transition-colors duration-300">Product List</a>
