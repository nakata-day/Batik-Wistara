...
<body class="bg-white flex flex-col min-h-screen">
    ...
    <!-- Dashboard User Page -->
    <h1 class="text-2xl font-bold p-6">Welcome, {{ Auth::user()->name }}</h1>
    <div class="p-6">
        <a href="{{ route('catalogue.index') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">View Catalogue</a>
        <a href="{{ route('transaction.index') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">View Transactions</a>
    </div>
