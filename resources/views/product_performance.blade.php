...
<head>
    ...
    <title>Product Performance - BatikWistara</title>
...
<body class="bg-white flex flex-col min-h-screen">
    ...
    <h1 class="text-2xl font-bold p-6">Product Performance</h1>
    <div class="p-6">
        <table class="min-w-full bg-white">
            ...
            <tbody>
                @foreach ($productSales as $productSale)
                    <tr>
                        <td class="py-2">{{ $productSale->product_id }}</td>
                        <td class="py-2">{{ $productSale->total_sales }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
