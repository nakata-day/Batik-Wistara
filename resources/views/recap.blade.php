...
<head>
    ...
    <title>Rekap Transaksi - TernakMart</title>
    ...
    <div class="container mx-auto p-4">
        ...
        <div class="flex justify-between items-center mb-2 no-print">
            @if(request('day') || request('month') || request('year'))
                <a href="{{ route('transaction.recap') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md shadow hover:bg-gray-600 transition">Tampilkan Semua</a>
            @endif
        </div>
