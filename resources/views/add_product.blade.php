...
<body class="bg-white flex flex-col min-h-screen">
    ...
    <nav class="bg-blue-500 p-4 flex justify-between items-center text-white">
        ...
        <div class="space-x-4">
            <a href="{{ route('catalogue.index') }}" class="bg-white text-blue-500 px-4 py-2 rounded hover:underline transition-colors duration-300">Back</a>
        </div>
    </nav>
    ...
    <div class="bg-gray-900 shadow-lg rounded-lg p-8 w-full max-w-3xl mx-auto mt-4 mb-4">
        ...
        <form action="{{ route('product.store') }}" method="POST" class="bg-gray-800 p-6 rounded shadow-md space-y-4">
            @csrf
