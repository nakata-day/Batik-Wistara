...
<body class="bg-white flex flex-col min-h-screen">
    ...
    <div class="container mx-auto p-4">
        ...
        <div class="flex justify-between items-center mb-2">
            <a href="<?php echo e(route('shopping')); ?>" class="bg-green-500 text-white px-4 py-2 rounded-md shadow hover:bg-green-600 transition">Buat Transaksi Baru</a>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 border-b text-center">
                            <form action="<?php echo e(route('transaction.destroy', $transaction)); ?>" method="POST">
                                ...
                                <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded-md shadow hover:bg-red-600 transition">Hapus</button>
                            </form>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH D:\Apps\laragon\www\batikwistara\resources\views/transaction.blade.php ENDPATH**/ ?>