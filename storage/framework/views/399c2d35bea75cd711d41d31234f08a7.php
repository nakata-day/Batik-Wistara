...
<head>
    ...
    <title>Landing Page - BatikWistara</title>
...
<body class="bg-white flex flex-col min-h-screen">
    ...
    <nav class="bg-blue-500 p-4 flex justify-between items-center text-white">
        ...
        <div class="space-x-4">
            <a href="<?php echo e(route('login')); ?>" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Login</a>
            <a href="<?php echo e(route('register')); ?>" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Register</a>
        </div>
    </nav>

    <!-- Landing Page -->
    <div class="text-center py-10">
        <h1 class="text-4xl font-bold text-blue-800">Welcome to BatikWistara</h1>
...
</html><?php /**PATH D:\Apps\laragon\www\batikwistara\resources\views/landing.blade.php ENDPATH**/ ?>